...
let localconfig = require('./dbconfig.json');

const connectionSettings = {
    host: process.env.DB_HOST || localconfig.database_host,  //configuratie host of heroku host
    user: process.env.DB_USER || localconfig.database_user,
    password: process.env.DB_PASSWORD,
    database: process.env.DB_DATABASE || localconfig.database_identifier,
    port: 3306,
    debug: false
}
